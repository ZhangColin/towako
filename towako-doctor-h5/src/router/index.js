...
import assistedReproduction from './modules/assisted-reproduction.js'
...
const routes = [
    ...
    children: [
      {
        ...
        meta: { title: '', icon: '', permission: ['login'] }
      }
    ]
  },
  ...
  {
    path: '/agreement/cooperation',
    name: 'agreement-cooperation',
    component: () => import('@/views/agreement/cooperation/index.vue'),
    meta: {
      title: '渠道推广合作协议'
    }
  },
  {
    path: '/agreement/commission',
    name: 'agreement-commission',
    component: () => import('@/views/agreement/commission/index.vue'),
    meta: {
      title: '优生惠平台返佣规则'
    }
  },
