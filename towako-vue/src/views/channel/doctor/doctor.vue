<template>
  <div class="app-container">
    <el-row :gutter="24" class="filter-container">
      <el-col :span="6">
        <el-input v-model="queryParam.name" class="filter-item" placeholder="请输入医生名称查询" />
      </el-col>
      <el-col :span="12">
    ...
    >
      ...
      <el-table-column align="center" label="医生名称" prop="name" />
...
import { enableDoctor, disableDoctor }
  from '@/api/channel/doctor-api'
